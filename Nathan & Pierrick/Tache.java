...
public class Tache {
    ...
    public String toString() {
    	return "Tâche "+id+" : Machine 1 {durée = "+durees[0]+" ; début = "+datesDebutSurMachines[0]+" ; fin = "+datesFinSurMachines[0]+" } \n          Machine 2 {durée = "+durees[1]+" ; début = "+datesDebutSurMachines[1]+" ; fin = "+datesFinSurMachines[1]+" } \n          Machine 3 {durée = "+durees[2]+" ; début = "+datesDebutSurMachines[2]+" ; fin = "+datesFinSurMachines[2]+" }";
    }
